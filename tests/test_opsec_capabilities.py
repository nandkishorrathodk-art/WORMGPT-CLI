...
class TestOPSECDrone:
    ...
    def test_test_tor_connection_success(self):
        ...
        mock_tor_tool.execute.return_value = {
            "success": True,
            "data": {"is_tor": True, "exit_ip": "185.220.101.1"},
        }
    ...
    def test_execute_command_via_tor_success(self):
        ...
        result = drone.execute(
            "execute_command_via_tor", {"command": "curl https://check.torproject.org"}
        )
...
class TestStateEncryption:
    ...
    def test_state_encryption_enabled(self):
        ...
        state_manager = StateManager(
            file_path="test_encrypted_state.json", encryption_key=encryption_key
        )
    ...
    def test_state_encryption_disabled(self):
        ...
        state_manager = StateManager(
            file_path="test_plain_state.json", encryption_key=None
        )
    ...
    def test_save_and_load_encrypted_state(self, mock_open, mock_exists):
        ...
        test_state = {
            "version": "0.11.0",
            "missions": [{"id": 1, "goal": "Test mission", "status": "completed"}],
        }
