...
class SecurityDrone(BaseDrone):
    ...
    def _analyze_contract(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if result["success"]:
            ...
            return self._success_response(
                data,
                f"Analysis complete: {data['total_issues']} vulnerabilities found"
            )
        else:
            return result
    ...
    def _generate_security_report(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if result["success"]:
            return self._success_response(
                result["data"],
                f"Generated {report_format} security report"
            )
        else:
            return result
    ...
    def _full_security_audit(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._success_response(
            audit_data,
            f"Security audit complete: {len(vulnerabilities)} issues found"
        )
    ...
    def _get_exploitation_steps(self, vuln_type: str) -> List[str]:
        ...
        return steps_map.get(vuln_type, [
    ...
    def _get_prerequisites(self, vuln_type: str) -> List[str]:
        prereq_map = {
            ...
            "unprotected-upgrade": [
                "Upgrade function must be accessible"
            ]
        }
    ...
    def _generate_poc_solidity_code(self, vulnerability: Dict[str, Any], target_contract: str) -> str:
        vuln_type = vulnerability.get("check", "unknown")
